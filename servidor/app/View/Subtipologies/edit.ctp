...
<?php echo $this->Form->create('Subtipology'); ?>
	<fieldset>
		<legend><?php echo __('Edit Subtipology'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Subtipology.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Subtipology.id'))); ?></li>
