...
<?php echo $this->Form->create('Tipology'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tipology'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Tipology.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Tipology.id'))); ?></li>
