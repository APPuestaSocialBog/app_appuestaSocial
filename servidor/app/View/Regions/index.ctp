<div class="regions index">
	...
	<thead>
	<tr>
			<th><?php echo $this->Paginator->sort('cod_departamento'); ?></th>
			<th><?php echo $this->Paginator->sort('cod_municipio'); ?></th>
			<th><?php echo $this->Paginator->sort('nombre_departamento'); ?></th>
			<th><?php echo $this->Paginator->sort('nombre_municipio'); ?></th>
	...
	<tr>
		<td><?php echo h($region['Region']['cod_departamento']); ?>&nbsp;</td>
		<td><?php echo h($region['Region']['cod_municipio']); ?>&nbsp;</td>
		<td><?php echo h($region['Region']['nombre_departamento']); ?>&nbsp;</td>
		<td><?php echo h($region['Region']['nombre_municipio']); ?>&nbsp;</td>
		<td class="actions">
