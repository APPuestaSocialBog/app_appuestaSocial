...
<h2><?php echo __('State'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($state['State']['createdby']); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($state['State']['modifiedby']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Deleted'); ?></dt>
		<dd>
			<?php echo h($state['State']['deleted']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php foreach ($state['Complaint'] as $complaint): ?>
		<tr>
